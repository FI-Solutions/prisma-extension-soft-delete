        ...
        params: {
            ...
            args: {
                ...
                where: {
                    ...where,
                    // allow overriding the deleted field in where
                    ...((0, nestedReads_1.isDeletedFieldOverWritten)(config.field, where)
                        ? {}
                        : { [config.field]: config.createValue(false) }),
                },
            },
        ...
        params: {
            ...
            args: {
                ...
                where: {
                    ...
                    // allow overriding the deleted field in where
                    ...((0, nestedReads_1.isDeletedFieldOverWritten)(config.field, (_f = params.args) === null || _f === void 0 ? void 0 : _f.where)
                        ? {}
                        : { [config.field]: config.createValue(false) }),
                },
            },
